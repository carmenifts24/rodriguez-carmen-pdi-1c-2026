...
Sobre cada recorte se produce un mapa anotado que senala los elementos compositivos seleccionados y el sentido que construyen.

**Conclusion:** El encuadre no es neutral. Un recorte puede transformar radicalmente la narrativa de una imagen sin modificar ningun pixel: cambia el contexto, aisla o conecta elementos, y dirige la atencion del espectador.
...
2. Abrir el notebook en VS Code o Jupyter
   ...
   ```text
   007_fotografia_digital/002_codigo/Trabajo Practico 006 - Fotografia Digital.ipynb
   ```
